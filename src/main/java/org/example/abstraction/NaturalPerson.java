...
public class NaturalPerson extends Taxpayer {
    ...
    public BigDecimal getIncome() {
        ...
        if (uniformTax) {
            return untaxedIncome.multiply(BigDecimal.ONE.subtract(UNIFORM_PERSONAL_INCOME_TAX));
        }
        return super.calculateProgressiveTax(untaxedIncome, PERSONAL_INCOME_TAX);
    }
